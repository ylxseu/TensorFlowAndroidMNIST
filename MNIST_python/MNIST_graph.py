...
def train(mnist):
   ...
   # Create new graph for exporting
    ...
    with g_2.as_default():
        ...
        W_1 = tf.constant(_W1, name="constant_W1")
        b_1 = tf.constant(_B1, name="constant_b1")
        W_2 = tf.constant(_W2, name="constant_W2")
        b_2 = tf.constant(_B2, name="constant_b2")
    
        y_2 = tf.nn.softmax(tf.matmul(tf.nn.relu(tf.matmul(x_2, W_1) + b_1),W_2)+b_2, name="output")
        sess_2 = tf.Session()
        ...
        tf.train.write_graph(graph_def, './tmp/ylx','ylx.pb', as_text=False)
